...
// Pin definitions
const byte ENCODER_BUTTON_PIN          = 5;
const byte ENCODER_B_PIN               = 6;
const byte ENCODER_A_PIN               = 7;

const byte AD9850_WORD_LOAD_CLOCK_PIN  = 8;     // (CLK)
const byte AD9850_FREQUENCY_UPDATE_PIN = 9;     // (FQ)
const byte AD9850_SERIAL_DATA_LOAD_PIN = 10;    // (DATA)
const byte AD9850_RESET_PIN            = 11;    // (RST).
